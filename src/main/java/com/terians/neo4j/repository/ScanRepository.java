...
public interface ScanRepository extends GraphRepository<Scan> {
    ...
    public Issue findDependencyIssue(String scanId, String dependencyId, String issueId);

    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_DEPENDENCY]->(d:Dependency {teriansId:{1}})-[:RELATED_DEPENDENCIES]->(rd:Dependency) RETURN rd")
    public Set<Dependency> findAllRelatedDependencies(String scanId, String dependencyId);
    ...
    public Dependency findRelatedDependency(String scanId, String dependencyId, String relatedDependencyId);

    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_PACKAGE]-> (p:Package) RETURN p")
    public Set<com.terians.neo4j.model.Package> findAllPackages(String scanId);
    ...
    public Set<Method> findAllMethods(String scanId, String packageId, String clazzId);
    ...
    public Method findMethod(String scanId, String packageId, String clazzId, String methodId);
