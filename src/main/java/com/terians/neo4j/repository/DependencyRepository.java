...
public interface DependencyRepository extends GraphRepository<Dependency> {
    ...
    public Vulnerability findVulnerability(String dependencyId, String vulnerabilityId);
    ...
    public Dependency findRelatedDependency(String dependencyId, String relatedDependencyId);
}
