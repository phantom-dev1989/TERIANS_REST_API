...
public interface ProjectRepository extends GraphRepository<Project> {
    ...
    public Dependency findDependency(String projectId, String scanId, String dependencyId);
    ...
    public Set<Method> findAllDependencyMethods(String projectId, String scanId, String dependencyId);
    ...
    public Method findDependencyMethod(String projectId, String scanId, String dependencyId, String methodId);
    ...
    public Set<Clazz> findAllDependencyClazzes(String projectId, String scanId, String dependencyId);
    ...
    public Clazz findDependencyClazz(String projectId, String scanId, String dependencyId, String clazzId);
    ...
    public Set<Vulnerability> findAllDependencyVulnerabilities(String projectId, String scanId, String dependencyId);
    ...
    public Vulnerability findDependencyVulnerability(String projectId, String scanId, String dependencyId, String vulnerabilityId);
    ...
    public Set<Issue> findAllDependencyIssues(String projectId, String scanId, String dependencyId);
    ...
    public Issue findDependencyIssue(String projectId, String scanId, String dependencyId, String issueId);
    ...
    public Set<Dependency> findAllRelatedDependencies(String projectId, String scanId, String dependencyId);
    ...
    public Dependency findRelatedDependency(String projectId, String scanId, String dependencyId, String relatedDependencyId);

    @Query("MATCH(p:Project {teriansId:{0}})-[:HAS_SCAN]->(s:Scan {teriansId:{1}})-[:HAS_PACKAGE]->" +
            "(p:Package) RETURN p")
    public Set<com.terians.neo4j.model.Package> findAllPackages(String projectId, String scanId);
    ...
    public Set<Clazz> findAllClazzes(String projectId, String scanId, String packageId);

    @Query("MATCH(p:Project {teriansId:{0}})-[:HAS_SCAN]->(s:Scan {teriansId:{1}})-[:HAS_PACKAGE]->(p:Package " +
            "{teriansId:{2}})-[:HAS_CLAZZ]->(c:Clazz {teriansId:{3}}) RETURN c")
    public Clazz findClazz(String projectId, String scanId, String packageId, String clazzId);

    @Query("MATCH(p:Project {teriansId:{0}})-[:HAS_SCAN]->(s:Scan {teriansId:{1}})-[:HAS_PACKAGE]->(p:Package " +
            "{teriansId:{2}})-[:HAS_CLAZZ]->(c:Clazz {teriansId:{3}})-[:HAS_METHOD]->(m:Method) RETURN m")
    public Set<Method> findAllMethods(String projectId, String scanId, String packageId, String clazzId);

    @Query("MATCH(p:Project {teriansId:{0}})-[:HAS_SCAN]->(s:Scan {teriansId:{1}})-[:HAS_PACKAGE]->(p:Package " +
            "{teriansId:{2}})-[:HAS_CLAZZ]->(c:Clazz {teriansId:{3}})-[:HAS_METHOD]->(m:Method {teriansId:{4}}) RETURN m")
    public Method findMethod(String projectId, String scanId, String packageId, String clazzId, String methodId);
