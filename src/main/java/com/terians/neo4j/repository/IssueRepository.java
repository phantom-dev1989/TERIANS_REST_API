...
public interface IssueRepository extends GraphRepository<Issue> {
    ...
    public Set<Issue> findIssuesByScanOrderedByIssueCountDesc(String scanId,
                                                              int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByCategoryCountDesc(String scanId,
                                                                 int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByFileNameCountDesc(String scanId,
                                                                 int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByPackageCountDesc(String scanId,
                                                                int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByClazzCountDesc(String scanId,
                                                              int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByIssueTypeDesc(String scanId,
                                                             int limit);
    ...
    public Set<Issue> findIssuesByScanOrderedByTechDebtDesc(String scanId,
                                                            int limit);
    ...
    public Set<Issue> findCriticalIssuesByScanOrderedByIssueCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.category) AND (i.category = \"PERFORMANCE\" "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByCategoryCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.fileName)AND (i.category = \"PERFORMANCE\" "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByFileNameCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.packageName) AND (i.category = \"PERFORMANCE\" "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByPackageCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:\"e20e1bb9-8ff9-45ba-bcd2-90ca81f7ef04\"})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByClazzCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.issueType) AND (i.category = \"PERFORMANCE\" "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByIssueTypeDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.techDebtMinutes) AND (i.category = \"PERFORMANCE\" "
            ...
            + "WHERE (i2.category = \"PERFORMANCE\" OR i2.category = \"MALICIOUS CODE VULNERABILITY\" OR i2.category = \"SECURITY\") return i2")
    public Set<Issue> findCriticalIssuesByScanOrderedByTechDebtDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findHighIssuesByScanOrderedByIssueCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.category)  AND (i.category = \"CORRECTNESS\" "
            ...
            + "OR i2.category = \"MULTITHREADED CORRECTNESS\") return i2")
    public Set<Issue> findHighIssuesByScanOrderedByCategoryCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.fileName) AND (i.category = \"CORRECTNESS\" "
            ...
            + "OR i2.category = \"MULTITHREADED CORRECTNESS\") return i2")
    public Set<Issue> findHighIssuesByScanOrderedByFileNameCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findHighIssuesByScanOrderedByPackageCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.className) AND (i.category = \"CORRECTNESS\" "
            ...
            + "WHERE (i2.category = \"CORRECTNESS\" OR i2.category = \"MULTITHREADED CORRECTNESS\") return i2")
    public Set<Issue> findHighIssuesByScanOrderedByClazzCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.issueType) AND (i.category = \"CORRECTNESS\" "
            ...
            + "OR i2.category = \"MULTITHREADED CORRECTNESS\") return i2")
    public Set<Issue> findHighIssuesByScanOrderedByIssueTypeDesc(String scanId,
                                                                 int limit);
    ...
    public Set<Issue> findHighIssuesByScanOrderedByTechDebtDesc(String scanId,
                                                                int limit);
    ...
    public Set<Issue> findMediumIssuesByScanOrderedByIssueCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.category)  AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByCategoryCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.fileName) AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "order by cfileName desc Limit {1} MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i2:Issue {fileName: dfileName, scanTool:\"FINDBUGS\"}) "
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByFileNameCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.packageName) AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "order by cpackageName desc Limit {1} MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i2:Issue {packageName: dpackageName, scanTool:\"FINDBUGS\"}) "
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByPackageCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.className) AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "order by cclassName desc Limit {1} MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i2:Issue {className: dclassName, scanTool:\"FINDBUGS\"}) "
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByClazzCountDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.issueType) AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByIssueTypeDesc(
            String scanId, int limit);
    ...
    @Query("MATCH (s:Scan {teriansId:{0}})-[:HAS_ISSUE]->(i:Issue {scanTool:\"FINDBUGS\"}) WHERE HAS(i.techDebtMinutes) AND (i.category = \"INTERNATIONALIZATION\" "
            ...
            + "WHERE (i2.category = \"INTERNATIONALIZATION\" OR i2.category = \"STYLE\" OR i2.category = \"DODGY CODE\" OR i2.category = \"EXPERIMENTAL\") return i2")
    public Set<Issue> findMediumIssuesByScanOrderedByTechDebtDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByIssueCountDesc(String scanId,
                                                                 int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByCategoryCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByFileNameCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByPackageCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByClazzCountDesc(String scanId,
                                                                 int limit);
    ...
    public Set<Issue> findLowIssuesByScanOrderedByIssueTypeDesc(String scanId,
                                                                int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByIssueCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByCategoryCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByFileNameCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByPackageCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByClazzCountDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByIssueTypeDesc(
            String scanId, int limit);
    ...
    public Set<Issue> findBestPracticesIssuesByScanOrderedByTechDebtDesc(
            String scanId, int limit);
